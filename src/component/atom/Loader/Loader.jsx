...
function Loader() {
    ...
    const handleLoginClick = () => {
        ...
        gsap.fromTo(
            ...
            { y: "0", opacity: 1, duration: 1, ease: "power3.out", display: "block" }
        );
    };
    ...
    return (
        <>
            {/* <div className="jsx_starter_container">
                <div className="js_loader_main_container">
                    <div className="js_logo_loader">
                        <svg id="Layer_2" data-name="Layer 2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 735.97 1048.54">
                            ...
                            <g id="Layer_1-2" data-name="Layer 1">
                                <g>
                                    ...
                                    <rect class="cls-1" x="315.66" y="732.98" width=".9" height=".45" />
                                    <path class="cls-1"
                        ...
                        <button className='requested_btn' onClick={handleLoginClick}>Request Access</button>

                    </div>

                </div>
                {isOpen ? <div className="jsx_form_main" ref={loginRef}>
                    <FormPopup />
                </div> : ""}
            ...
            <div className="jsx_starter_container">
                ...
                {isOpen && (
                    <div className="jsx_form_main" ref={loginRef}>
                        <FormPopup />
                    </div>
                )}
            </div>
